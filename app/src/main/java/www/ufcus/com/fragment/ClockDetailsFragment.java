...
public class ClockDetailsFragment extends BaseFragment implements OnRefreshListener, OnLoadMoreListener, LoaderManager.LoaderCallbacks<ArrayList<ClockDetailResult>>, MainActivity.MainCallBack {
    ...
    private static class DataAsyncLoader extends AsyncTaskLoader<ArrayList<ClockDetailResult>> {
        ...
        public ArrayList<ClockDetailResult> loadInBackground() {
            ...
            Cursor c = context.getContentResolver().query(ClockBean.ITEMS_URI, new String[]{ClockBean.GROUP_BY, ClockBean._ID, ClockBean.PHONE_NUMBER, ClockBean.GROUP_BY, "MAX(" + ClockBean.CLOCK_TIME + ") as " + ClockDetailResult.AS_LAST_TIME, "MIN(" + ClockBean.CLOCK_TIME + ") as " + ClockDetailResult.AS_FIRST_TIME}, " 1=1" + " ) " + " group by (" + ClockBean.GROUP_BY, null, null);
    ...
    public void onBackPressed() {
        ...
        EventBus.getDefault().post(new SwitchFragmentEvent(MainActivity.CLOCK_FRAGMENT));
    }
